...
use crate::downloads::output_parser::DownloadOutputParser;
use crate::downloads::result_parser;
use crate::downloads::{DownloadQueueItem, DownloadQueueStatus};
use crate::ipatool::client::ClientError;
...
impl<'a> ChunkContext<'a> {
    ...
    fn flush(&self) -> crate::downloads::output_parser::DownloadOutputUpdate {
